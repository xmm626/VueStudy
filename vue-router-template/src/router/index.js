			...
			children: [{
				...
				},
				{
					...
					children: [{
							//题库
							path: '/user_TK',
							component: resolve => require(['../components/Tiku.vue'], resolve),
							meta: {
								title: '题库'
							}
						},
						{
							//资源库
							path: '/user_ZY',
							component: resolve => require(['../components/Ziyuan.vue'], resolve),
							meta: {
								title: '资源库'
							}
						},
						{
							//活动库
							path: '/user_HD',
							component: resolve => require(['../components/Huodong.vue'], resolve),
							meta: {
								title: '活动库'
							}
						}
